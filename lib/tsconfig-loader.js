...
function mergeTsconfig(base, _config) {
    var config = __assign({}, _config);
    var newCompilerOptions = config.compilerOptions;
    delete config.compilerOptions;
    var ret = __assign({}, base, config);
    ret.compilerOptions = __assign({}, base.compilerOptions, newCompilerOptions);
    return ret;
}
